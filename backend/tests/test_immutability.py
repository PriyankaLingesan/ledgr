...
# Every guard here (`ledgr_reject_mutation`, the transaction-immutability
# trigger) raises with ERRCODE 'restrict_violation' - SQLSTATE class 23,
# "integrity constraint violation" - which psycopg/SQLAlchemy map to
# IntegrityError, not InternalError or ProgrammingError.
DB_ERRORS = (IntegrityError,)
