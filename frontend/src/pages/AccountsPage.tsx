    ...
    <>
      ...
      <div className="px-5 py-6 sm:px-8">
                          ...
                          <span
                            className={
                              account.normal_balance === 'DEBIT'
                                ? 'text-[0.8125rem] font-medium text-debit-ink'
                                : 'text-[0.8125rem] font-medium text-credit-ink'
                            }
                          >
        ...
        <p className="mt-3 text-[0.8125rem] text-ink-3">
          Balances shown here are read from the account balance cache. Open an account to see the
          balance re-derived from its ledger entries.
        </p>
      </div>
